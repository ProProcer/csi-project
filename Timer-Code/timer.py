...
class TimeTracker:
    def __init__(self, root):
        ...
        instructions = [
            ...
            "Press 'W' to start/stop recording 'walking'",
            "Press 'E' to start/stop recording 'jumping_jack'",
            "Press 'R' to start/stop recording 'lunges'"
        ...
        self.root.bind('Q', lambda event: self.toggle_motion("squat"))
        self.root.bind('w', lambda event: self.toggle_motion("walking"))
        self.root.bind('W', lambda event: self.toggle_motion("walking"))
        self.root.bind('e', lambda event: self.toggle_motion("jumping_jack"))
        self.root.bind('E', lambda event: self.toggle_motion("jumping_jack"))
        self.root.bind('r', lambda event: self.toggle_motion("lunges"))
        self.root.bind('R', lambda event: self.toggle_motion("lunges"))
